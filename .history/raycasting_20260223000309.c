...
/*   Updated: 2025/10/20 11:51:20 by lalves-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void raycasting_loop(t_game *game)
{
    ...
    for (x = 0; x < SCREEN_WIDTH; x++)
    {
        ...
        // espelhamento (pra não ficar invertido)
        ...
        // (por enquanto) cor sólida — textura entra na próxima task (tex_y)
        if (hit_char == 'D')
            color = 0xAA6600;
        ...
        // evita warning enquanto ainda não usamos tex/tex_x (remova quando texturizar)
        (void)tex_x;
        (void)tex;
    }
}
