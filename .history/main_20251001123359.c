...
game.textura.my_asset_adr=mlx_get_data_addr(game.textura.my_asset,game.textura.my_asset.bpp, game.textura.my_asset.line_len, game.textura.my_asset.endian);
