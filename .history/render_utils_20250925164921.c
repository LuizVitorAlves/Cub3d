...
void draw_wall_slice(t_game *game, int x, double perp_wall_dist, int side)
{
    ...
    int tex_width = 64;   // coloque aqui a largura da sua textura
    int tex_height = 64;  // coloque aqui a altura da sua textura
    ...
    // Posição exata da parede para mapear a textura
    double wall_x;
