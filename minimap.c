...
/*   Updated: 2025/11/04 12:23:13 by lalves-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void draw_rect_transparent(t_game *game, int x_start, int y_start, int w, int h, int color)
{
    int y;
    int x;
...
static void draw_rect_solid(t_game *game, int x_start, int y_start, int w, int h, int color)
{
    int y;
    int x;
...
static void draw_map_tiles(t_game *game)
{
    ...
    while (game->cfg.map[y])
    {
        ...
        {
            screen_x = (x * TILE_SIZE) + MAP_OFFSET_X;
            screen_y = (y * TILE_SIZE) + MAP_OFFSET_Y;
            tile = game->cfg.map[y][x];
            if (tile == '1')
                draw_rect_transparent(game, screen_x, screen_y, \
...
void    render_minimap(t_game *game)
{
    ...
    draw_rect_solid(game, player_screen_x - (PLAYER_SIZE / 2), \
